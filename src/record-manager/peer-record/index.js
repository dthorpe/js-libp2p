...
class PeerRecord extends Record {
   ...
   * @constructor
   * @param {PeerId} peerId
   * @param {Array<multiaddr>} multiaddrs public addresses of the peer this record pertains to.
   * @param {number} [seqNumber] monotonically-increasing sequence counter that's used to order PeerRecords in time.
   */
